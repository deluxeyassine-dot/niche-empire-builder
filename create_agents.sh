...
# Create PromptGeneratorAgent.ts
cat > "C:\Users\User\.qwen\claude code cla\niche-empire-builder\src\agents\PromptGeneratorAgent.ts" << 'EOF'
/**
...
echo "Created PromptGeneratorAgent.ts"
